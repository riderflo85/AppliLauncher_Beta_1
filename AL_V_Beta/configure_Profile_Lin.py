...
if creation == "oui" or creation == "o":
	...
	with open('config_Linux.json', 'x') as fichierconfig:
	...
	with open('config_Linux.json', 'r') as fichierconfig:
	...
	with open('config_Linux.json', 'w') as fichierconfig:
